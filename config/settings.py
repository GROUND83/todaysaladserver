...
ALLOWED_HOSTS = [".elasticbeanstalk.com", "52.78.100.19", "52.78.48.223", "127.0.0.1"]
...
if DEBUG:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ("RDS_HOST_NAME"),
            "USER": os.environ("RDS_HOST_USER"),
            "PASSWORD": os.environ("RDS_HOST_PASSWORD"),
